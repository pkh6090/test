...
<body>
	<%
		...
		String regdate2 = multi.getParameter("regdate2");	
	...
	<sql:update dataSource="${dataSource}" var="resultSet">	
		...
		update member	
		set name = ?, gender = ?, birth = ?, mail = ?, phone = ?, address = ?, address2 = ?, regdate2 = ?, postcd = ?
		where id = ? and passwd = ?	
	...
	<c:redirect url="resultMember.jsp?gubun=update"></c:redirect>		

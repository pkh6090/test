...
<body>	
	...
	<sql:setDataSource
			...
			url="jdbc:mysql://localhost:3306/loldb"
			user="root"
			password="1234"
	/>
	...
	<div class="container">	
		...
		<form name="newMember" action="processupdateMember.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
			
			<div class="form-group row">			
				<label class="col-sm-2">아이디</label> <!-- col-sm-2 : sm=small,lg=large -->
				<div class="col-sm-3">
					<input type="text" name="id" class="form-control" value="<c:out value='${row.id}'/>">
				</div>				
			</div>		
			...
			<div class="form-group row">			
				...
				<div class="col-sm-3">
					<input type="password" name="passwd" class="form-control" readonly="readonly" value="<c:out value='${row.passwd}'/>">
				</div>				
			</div>
			...
			<div class="form-group row">			
				...
				<div class="col-sm-3">
					<input type="text" id="birth" name="birth" class="form-control" value="<c:out value='${row.birth}'/>">
				</div>				
			</div>		
			...
			<div class="form-group row">			
				...
				<div class="col-sm-3">
					<input type="text" name="email" class="form-control" value="<c:out value='${row.mail}'/>">
				</div>				
			</div>
			...
			<div class="form-group row">			
				...
				<div class="col-sm-3">
					<input type="text" class="phone" name="phone" class="form-control" value="<c:out value='${row.phone}'/>">
				</div>				
			</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input id="zipCode" name="zipCode" readonly="readonly" type="text" value="<c:out value='${row.postcd}'/>" class="form-control"/>
			...
			<div class="form-group row">			
				...
				<div class="col-sm-5">
					<input type="text" id="addressName" name="address" class="form-control" value="<c:out value='${row.address}'/>">
				</div>				
			</div>		
			...
			<div class="form-group row">			
				...
				<div class="col-sm-5">
					<input type="text" id="addressName2" name="address2" class="form-control" value="<c:out value='${row.address2}'/>">
				</div>				
			</div>
			
			<div class="form-group row">			
				<label class="col-sm-2">수정일자</label> <!-- col-sm-2 : sm=small,lg=large -->
				<div class="col-sm-3">					
					<input type="text" name="regdate2" readonly="readonly" value="<fmt:formatDate value="${now}" type="both"/>" class="form-control">
				</div>				
			</div>		
